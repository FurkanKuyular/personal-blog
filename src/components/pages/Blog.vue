      ...
      <div class="row">
        <div class="blog-card">
          <div class="img-holder">
            <img src="../../../public/frontend/assets/imgs/blog1.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
          </div>
        ...
        <div class="blog-card">
          <div class="img-holder">
            <img src="../../../public/frontend/assets/imgs/blog2.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
          </div>
          <div class="content-holder">
        ...
        <div class="blog-card">
          <div class="img-holder">
            <img src="../../../public/frontend/assets/imgs/blog3.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
          </div>
          <div class="content-holder">
